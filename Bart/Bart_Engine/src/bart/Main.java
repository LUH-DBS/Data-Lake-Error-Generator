...
public class Main {
    ...
    public static void main(String[] args) {
        String[] llun_prefix = SpeedyConstants.getNumericLlunPrefixes();
        llun_prefix[0] = "PLACEHOLDER";
        llun_prefix[1] = "PLACEHOLDER";
        SpeedyConstants.setNumericSkolemPrefixes(new String[]{"PLACEHOLDER"});
        if (args.length < 1) {
            printUsage();
            return;
        }
